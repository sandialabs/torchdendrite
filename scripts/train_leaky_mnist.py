...
from torchdendrite.models import MNISTDendFCLeakyNet
from torchdendrite.utils import trainer

parser = argparse.ArgumentParser(
    description="Arguments for DendriticLinear MNIST Training"
)
parser.add_argument(
    "--experiment_name",
...
model = MNISTDendFCLeakyNet(resolution=args.resolution).to(args.device)
train = MNIST(
    "datasets",
    train=True,
    download=True,
